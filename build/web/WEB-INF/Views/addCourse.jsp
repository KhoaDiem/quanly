        ...
        <div class="row">
            <div class="col-sm-2" style="background-color:lavender;">
                <div class="list-group">
                    ...
                    <a href="../quanly/listCourse.html" class="list-group-item active main-color-bg">
                        <span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Course Management
                    </a>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="container">
                            <div class="panel panel-primary">
                                <div class="panel-body">
                                    <form method="POST" action="saveCourse.html">
                                        <div class="form-group">
                                            <label for="courseName">Course name:</label>
                                            <input  value="${course.courseID}" type="number" class="form-control" id="id" name="id"hidden="true"/>
                                            <input required="true" value="${course.courseName}" type="text" class="form-control" id="courseName" name="courseName" />
                                        </div>
                                        <div class="form-group">
                                            <label for="description">Description:</label>
                                            <input required="true" value="${course.description}" type="text" class="form-control" id="description" name="description" />
                                        </div>
